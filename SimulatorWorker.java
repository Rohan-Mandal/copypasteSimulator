...
public class SimulatorWorker {
    ...
    private final SimulatorFrame xFrame;
    private final AtomicInteger isRunning;
    private int startTime = 5;
    private int keyStrokeDelay = 100;

    public SimulatorWorker(SimulatorFrame frame) throws AWTException {
    ...
    private void runTyper(String keys) {
        for (int i = 0; i < startTime; i++) {
            ...
            xFrame.lableInfo.setText("Starting typing in " + (startTime - i) + " sec");
            try {
                Thread.sleep(1000L);
            } catch (InterruptedException ex) {
            }
        }
        xFrame.lableInfo.setText("Running  now..");
        ...
        for (int i = 0; i < charArray.length; i++) {
            ...
            try {
                ...
                xFrame.progress.setValue(progress);
                /*
                 ...
                 * stop very frequently for long paragraphs and stop adequately for short paragraphs
                 */
